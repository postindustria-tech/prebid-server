...
func TestParseRequestParseImpInfoError(t *testing.T) {
	...
	hookExecutor := hookexecution.NewHookExecutor(deps.hookExecutionPlanBuilder, hookexecution.EndpointAuction, deps.metricsEngine, &hookexecution.ABTests{Config: &config.Configuration{}})
