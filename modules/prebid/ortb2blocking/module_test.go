...
func TestHandleBidderRequestHook(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			bidRequest:         &openrtb2.BidRequest{Imp: []openrtb2.Imp{{ID: "ImpID1", Banner: &openrtb2.Banner{}, Video: &openrtb2.Video{}}}},
			expectedBidRequest: &openrtb2.BidRequest{Imp: []openrtb2.Imp{{ID: "ImpID1", Banner: &openrtb2.Banner{}, Video: &openrtb2.Video{}}}},
			expectedHookResult: hookstage.HookResult[hookstage.BidderRequestPayload]{},
